...
INSERT INTO "new_FellowshipGroup" ("createdAt", "createdById", "description", "gender", "id", "imageUrl", "maxLeaders", "maxMembers", "name", "scheduleDetails", "scheduleType", "updatedAt", "updatedById", "visibility") SELECT "createdAt", "createdById", "description", "gender", "id", "imageUrl", "maxLeaders", "maxMembers", "name", "scheduleDetails", "scheduleType", "updatedAt", "updatedById", "visibility" FROM "FellowshipGroup";
